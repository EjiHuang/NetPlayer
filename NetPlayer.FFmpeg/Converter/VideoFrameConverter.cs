/*
 https://github.com/sipsorcery-org/SIPSorceryMedia.FFmpeg/blob/master/src/VideoFrameConverter.cs
 */
...
namespace NetPlayer.FFmpeg.Converter
{
    public sealed unsafe class VideoFrameConverter : IDisposable
    {
           ...
           int dstWidth, int dstHeight, AVPixelFormat destinationPixelFormat)
        {
            ...
            logger.Debug($"Successfully initialised ffmpeg based image converted for {srcWidth}:{srcHeight}:{sourcePixelFormat}->{dstWidth}:{dstHeight}:{_dstPixelFormat}.");
        }
